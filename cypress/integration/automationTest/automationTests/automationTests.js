...
Then('I Should See Alice Cathcart Modal', function () {
  ...
  cy.get(loanpalLocators.aliceCathcartModal).should(
    'have.attr',
    'src',
    'https://res.cloudinary.com/loanpal/image/upload/w_auto,q_auto,f_auto,dpr_auto,c_scale/v1582051733/loanpal.com/leadership/about-us/AlicePopup2.jpg'
  );
  cy.get(loanpalLocators.aliceCathcartModal)
    .should('have.attr', 'src')
    .should('include', 'AlicePopup2.jpg');
});
...
Then('I Should See Brendon Merkleys Modal', function () {
  ...
  cy.get(loanpalLocators.berndonMerkleyModal).should(
    'have.attr',
    'src',
    'https://res.cloudinary.com/loanpal/image/upload/w_auto,q_auto,f_auto,dpr_auto,c_scale/v1571435514/loanpal.com/leadership/about-us/MerkleyPopup.jpg'
  );
  cy.get(loanpalLocators.berndonMerkleyModal)
    .should('have.attr', 'src')
    .should('include', 'MerkleyPopup.jpg');
});
